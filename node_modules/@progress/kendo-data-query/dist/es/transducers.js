...
var aggregatesFuncs = function (name) { return ({
    ...
    count: function () {
        var state = 0;
        return {
            calc: function (value) { return state++; },
 ...
 */
export var filter = function (predicate) { return (function (reduce) { return (function (acc, curr, index) { return predicate(curr) ? reduce(acc, curr) : acc; }); }); };
/**
 * @hidden
 */
 ...
 */
export var take = function (count) { return (function (reduce) { return (function (acc, curr, index) { return count-- > 0 ? reduce(acc, curr) : reduced(acc); }); }); };
/**
 * @hidden
 * Returns a reducer that will take the specified number of items.
 */
export var takeWhile = function (predicate) { return (function (reduce) { return (function (acc, curr, index) { return predicate(curr) ? reduce(acc, curr) : reduced(acc); }); }); };
/**
 * @hidden
 * Returns a reducer that will skip the specified number of items.
 */
export var skip = function (count) { return (function (reduce) { return (function (acc, curr, index) { return count-- <= 0 ? reduce(acc, curr) : acc; }); }); };
/**
 * @hidden
