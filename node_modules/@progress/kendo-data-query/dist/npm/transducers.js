 ...
 */
exports.filter = function (predicate) { return (function (reduce) { return (function (acc, curr, index) { return predicate(curr) ? reduce(acc, curr) : acc; }); }); };
/**
 * @hidden
 */
 ...
 */
exports.take = function (count) { return (function (reduce) { return (function (acc, curr, index) { return count-- > 0 ? reduce(acc, curr) : reduced(acc); }); }); };
/**
 * @hidden
 * Returns a reducer that will take the specified number of items.
 */
exports.takeWhile = function (predicate) { return (function (reduce) { return (function (acc, curr, index) { return predicate(curr) ? reduce(acc, curr) : reduced(acc); }); }); };
/**
 * @hidden
 * Returns a reducer that will skip the specified number of items.
 */
exports.skip = function (count) { return (function (reduce) { return (function (acc, curr, index) { return count-- <= 0 ? reduce(acc, curr) : acc; }); }); };
/**
 * @hidden
